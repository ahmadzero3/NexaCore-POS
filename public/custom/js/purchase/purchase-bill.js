"use strict";
    ...
    // Add this block to show the default row if table is empty
    var tableBody = tableId.find('tbody');
    if (tableBody.children('tr').length === 0) {
        tableBody.append('<tr><td colspan="16" class="text-center fw-light fst-italic default-row">No items are added yet !!</td></tr>');
    }
}
    /**
     * Delete Row
