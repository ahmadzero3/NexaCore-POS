...
function addRowToInvoiceItemsTable(
    ...
    var inputTotal =
        ...
        currentRowId +
        ']" class="form-control form-control-plaintext text-end" readonly  value="0">';
    ...
    newRow.append(
        `<td class="${!itemSettings.show_mrp ? "d-none" : ""}">` + mrp + "</td>"
    );
    newRow.append(
...
function showNoItemsMessageIfEmpty() {
    ...
    if (itemRows.length === 0) {
        $tbody.html(
            "<tr>" +
                '<td colspan="13" class="text-center fw-light fst-italic default-row">' +
