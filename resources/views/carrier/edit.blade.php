@extends('layouts.app')
@section('title', __('carrier.update'))
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="carrierForm" action="{{ route('carrier.update') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-input type="text" name="name" :required="true" value="{{ $carrier->name }}"/>
                                    </div>
                                    <div class="col-md-6">
                                        <x-label for="email" name="{{ __('app.email') }}" />
                                        <x-input type="email" name="email" :required="false" value="{{ $carrier->email }}"/>
                                    </div>
                                    <div class="col-md-6">
                                        <x-label for="phone" name="{{ __('app.phone') }}" />
                                        <x-input type="number" name="phone" :required="false" value="{{ $carrier->phone }}"/>
                                    </div>
                                    <div class="col-md-6">
                                        <x-label for="mobile" name="{{ __('app.mobile') }}" />
                                        <x-input type="number" name="mobile" :required="false" value="{{ $carrier->mobile }}"/>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-textarea name="address" value="{{ $carrier->address }}"/>
                                    </div>
                                    <div class="col-md-6">
                                        <x-label for="note" name="{{ __('app.note') }}" />
                                        <x-textarea name="note" value="{{ $carrier->note }}"/>
                                    </div>
                                    <div class="col-md-12">
