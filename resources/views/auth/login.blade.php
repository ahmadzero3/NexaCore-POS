			...
			<div class="row g-0">
				...
				<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left align-items-center justify-content-center d-none d-xl-flex">
					...
					<div class="shadow-none bg-transparent shadow-none rounded-0 mb-0">
						<div class="card-body">
							<img src="assets/images/login-images/bg-login.png" class="img-fluid " width="650" alt="" />
						</div>
					</div>
						...
						<div class="card-body p-sm-5">
							...
							<div class="">
								<div class="text-center">
									<img src={{ url("/app/getimage/" . app('site')['colored_logo']) }} width="165px" alt="">
								</div>
								...
								<div class="form-body">
									<form class="row g-3" id="loginForm" action="{{ route('login') }}" enctype="multipart/form-data">
										...
										<div class="col-12">
											...
											<x-input placeholder="Enter Username" id="username" name="username" type='text' :required="true" :autofocus="true" :autocomplete='true' />
										</div>
