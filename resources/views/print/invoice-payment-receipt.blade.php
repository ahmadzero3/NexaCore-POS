        ...
        <div class="invoice">
            ...
            <table class="table-bordered custom-table table-compact" id="item-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tfoot-first-td"><strong>{{ __('app.total_lebanon') }}</strong></td>
                        <td class="text-end">{{ $formatNumber->formatWithPrecision($sale->grand_total * $sale->exchange_rate) }}</td>
                    </tr>
                    @endif
                    <tr>
                        <td>
