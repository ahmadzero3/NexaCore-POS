            ...
            <div class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center gap-1">
                    ...
                    <li class="nav-item position-relative">
                        <a href="#" class="btn btn-sm btn-outline-secondary notification-circle" data-bs-toggle="dropdown">
                            <i class='bx bx-bell bell-icon'></i>
                            <span class="notification-badge position-absolute top-0 start-100 translate-middle badge">
                                0
                            </span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-start notification-dropdown">
                            ...
                            <li class="dropdown-item text-end">
                                <a href="{{ route('item.list') }}">View All &gt;</a>
                            </li>
                        </ul>
