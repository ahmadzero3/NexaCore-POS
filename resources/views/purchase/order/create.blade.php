...
@section('content')
    ...
    <div class="page-wrapper">
        <div class="page-content">
            <x-breadcrumb :langArray="['purchase.purchase', 'purchase.order.list', 'purchase.order.create']" />
            <div class="row">
                <form class="g-3 needs-validation" id="invoiceForm" action="{{ route('purchase.order.store') }}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <x-dropdown-general optionNaming="purchaseOrderStatus" selected=""
                                ...
                                <div class="card-body p-4 row g-3">
                                    ...
                                    <div class="col-md-12 table-responsive">
                                        <table class="table mb-0 table-striped table-bordered" id="invoiceItemsTable">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td class="fw-bold text-end tfoot-first-td" colspan="13">
                                                        <!-- Adjusted colspan -->
                                                        {{ __('app.total') }}
                                                    </td>
