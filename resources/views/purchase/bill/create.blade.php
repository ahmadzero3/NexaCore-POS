                            ...
                            <div class="card-body p-4 row g-3">
                                ...
                                <div class="col-md-12 table-responsive">
                                    <table class="table mb-0 table-striped table-bordered" id="invoiceItemsTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="16" class="text-center fw-light fst-italic default-row">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="fw-bold text-end tfoot-first-td sum_of_total">
                                                    0
                                                </td>
                                                <td class="fw-bold text-end" colspan="{{ 12 }}">
                                                    <!-- This colspan should cover the remaining columns to the end of the table -->
                                                </td>
