                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="currencyForm" action="{{ route('currency.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <x-input type="text" name="code" :required="true" placeholder="USD | INR | KWD" value="" :minlength=3 :maxlength=3 />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <x-input type="text" additionalClasses="cu_numeric" name="exchange_rate" placeholder="0.000000" :required="true" value="" :autofocus='false'/>
                                    </div>

                                    <div class="col-md-12 d-none">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="is_company_currency" name="is_company_currency">
