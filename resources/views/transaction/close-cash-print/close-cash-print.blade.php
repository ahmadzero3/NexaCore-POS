<link rel="stylesheet" href="{{ asset('custom/css/transaction/close-cash-print.css') }}">


<div class="receipt">
    <div class="header">
        <span class="date">{{ \Carbon\Carbon::now()->format('d-m-Y') }}</span>
        <h2 class="logo-text text-center">{{ app('site')['name'] }}</h2>
...
<script src="{{ asset('custom/js/transaction/close-cash-print.js') }}"></script>
