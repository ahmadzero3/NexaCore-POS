...
<link rel="stylesheet" href="{{ asset('assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-timepicker.min.css') }}" />
@endsection
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-header px-4 py-3 d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <h5 class="mb-0 text-uppercase">{{ __('app.close_cash') }} ({{ \Carbon\Carbon::now()->format('d-m-Y') }})</h5>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <!---From Time Right Side---->
                    <!---
                    <div class="col-md-3">
                        <x-label for="from_time" name="{{ __('app.from_time') }}" />
                        <a tabindex="0" class="text-primary" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Filter by From Time"><i class="fadeIn animated bx bx-info-circle"></i></a>
                        <div class="input-group mb-3">
                            <x-input type="text" additionalClasses="timepicker-edit" name="to_time" :required="true" value="" />
                            <div class="timepicker"></div>
                            <span class="input-group-text" id="input-near-focus" role="button"><i class="fadeIn animated bx bx-time-five"></i></span>
                        </div>
                    </div>---->
                    ...
                    <div class="col-md-3 mx-auto">
                        ...
                        <div class="input-group mb-3">
                            <x-input type="text" name="opening_balance" :required="true" value="{{ number_format($openingBalance, 2) }}" readonly />
                        </div>
                    </div>
                    ...
                    <!---
                    <div class="col-md-3">
                        <x-label for="to_time" name="{{ __('app.to_time') }}" />
                        <a tabindex="0" class="text-primary" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Filter by To Time"><i class="fadeIn animated bx bx-info-circle"></i></a>
                        <div class="input-group mb-3">
                            <x-input type="text" additionalClasses="timepicker-edit" name="from_time" :required="true" value="" />
                            <div class="timepicker"></div>
                            <span class="input-group-text" id="input-near-focus" role="button"><i class="fadeIn animated bx bx-time-five"></i></span>
                        </div>
                    </div>---->
            ...
            <div class="card-body">
                <div class="d-flex">
                    ...
                    <div class="col-md-6 custom-col-45">
                        <form id="saleInvoiceForm" class="row g-3 needs-validation" action="{{ route('sale.invoice.delete') }}">
                            {{-- CSRF Protection --}}
                            @csrf
                            @method('POST')
                    ...
                    <div class="col-md-6 custom-col-45 move-down">
                        <form id="expenseForm" class="row g-3 needs-validation" action="{{ route('expense.delete') }}">
                            {{-- CSRF Protection --}}
                            @csrf
                            @method('POST')
                            <div class="table-responsive">
        ...
        <div class="card">
            <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped no-stripe mb-0 table-three">
                                <tbody>
                                    <tr class="table-3-tr-1">
                                        ...
                                        <td class="w-50 bg-gray text-right tr-p">{{ number_format($openingBalance, 2) }}</td>
                                    </tr>
                                    <tr class="table-3-tr-2">
                                        <td class="w-50 bg-gray text-right tr-p">Today Income</td>
                                        <td class="w-50 bg-gray text-right tr-p">{{ number_format($todayIncome, 2) }}</td>
                                    </tr>
                                    <tr class="bg-green">
                                    ...
                                    <tr class="bg-blue">
                                        ...
                                        <td class="w-50 text-right tr-p">{{ number_format($totalIncome - $todayExpenses, 2) }}</td>
                                    </tr>
                                    <tr class="bg-yellow">
                                        <td class="w-50 text-right tr-p">
                ...
                <!-- Add the danger button here -->
                <div class="text-end mt-3">
                    <button type="button" class="btn btn-danger close">{{ __('app.accept_close_cash') }}</button>
                </div>
            </div>
        </div>
